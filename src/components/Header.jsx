  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        {/* GitHub Issues / Ideas */}
        <a
          href="https://github.com/dpqgvryhph-pixel/minecraft-rp-creator/issues/new"
          target="_blank"
          rel="noopener noreferrer"
          title="Ötlet beküldése vagy hibajelentés a GitHubon"
          className="flex items-center gap-1.5 px-2 py-1 bg-gray-800 hover:bg-gray-700 border border-gray-600 rounded-lg text-xs text-gray-300 hover:text-white transition-colors"
        >
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path>
          </svg>
          <span className="hidden md:inline font-medium">Ötlet beküldése</span>
        </a>
